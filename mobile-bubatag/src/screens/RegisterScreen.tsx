...
import { KeyboardAvoidingView, Platform, Text, TouchableOpacity, TextInput, View } from "react-native";
...
export default function RegisterScreen({ onNavigateToLogin }: RegisterScreenProps) {
  ...
  return (
    <View className="flex-1 bg-tertiary px-8 justify-center">
      <Svg
        width="120%"
        height="100%"
      ...
      <View
        style={{ position: "absolute", top: -50, left: -120, width: 240, height: 240, opacity: 0.5 }}
        pointerEvents="none"
      >
